...
3. **Get actual credentials:**
   > ⚠️ **Important:** The `.env` file contains sensitive credentials and is not committed to git.
   > 
   > **Contact me** to get the actual `.env` file with:
   > - Blacklane AI API keys
