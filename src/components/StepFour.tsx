...
export default function StepFour({ releaseTitle, selectedComponents, onUpdate, onBack, onNext }: StepFourProps) {
      ...
      <div className="space-y-6 mb-8">
        ...
        <div className="p-4 bg-cursor-bg rounded-lg border border-cursor-border">
          ...
          <div className="space-y-1 text-sm text-cursor-muted">
            ...
            <div>• Publishing: <span className="text-cursor-text">Draft</span></div>
          </div>
        </div>
      </div>
